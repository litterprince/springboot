...
public class UserController {
    ...
    @ResponseBody
    public Map<String, Object> query(HttpServletRequest request, @RequestParam Integer offset, @RequestParam Integer limit) throws Exception{
    ...
    public void insert(HttpServletRequest request, HttpServletResponse response, UserBean user) throws Exception{
    ...
    public void update(HttpServletRequest request, HttpServletResponse response, UserBean user) throws Exception{
        JSONObject result = new JSONObject();
        user.setCreateTime(new Date());
